...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>Pages - Admin Dashboard UI Kit - Color</title>
            ...
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href="#" class="active">Color</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
          ...
          <div class="container-fluid container-fixed-lg">
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-heading">
                    <div class="panel-title">Eight base color pallete
                    </div>
                  </div>
                  <div class="panel-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3 col-sm-6">
                        <div class="bg-complete b-a b-grey m-b-15">
                          <div class="bg-white m-t-45 padding-10">
                            <p class=" no-margin pull-left">Complete color</p>
                            <p class=" no-margin pull-right">100%</p>
                            <div class="clearfix"></div>
                          </div>
                        </div>
                ...
                <div class="panel panel-transparent">
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-master-darkest text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-master-darker text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-master-dark  text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-master b-a b-grey no-padding">
                    ...
                    <div class="row m-t-10">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-master-light">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-master-lighter">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-master-lightest">
          ...
          <div class="container-fluid container-fixed-lg m-t-20">
            <div class="row">
              <div class="col-sm-4">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-heading">
                    <div class="panel-title">Chroma base colors
                    </div>
                  </div>
                  <div class="panel-body">
          ...
          <div class="container-fluid container-fixed-lg m-t-20">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-primary-darker text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-primary-dark text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-primary no-padding b-a b-grey text-master">
                        <div class="bg-white m-t-45 p-t-5 p-l-15 p-b-5 p-r-15">
                    ...
                    <div class="row m-t-10">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-primary-light text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-primary-lighter text-white">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-complete-darker text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-complete-dark text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-complete no-padding b-a b-grey text-master">
                        <div class="bg-white m-t-45 p-t-5 p-l-15 p-b-5 p-r-15">
                    ...
                    <div class="row m-t-10">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-complete-light text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-complete-lighter text-white">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-success-darker text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-success-dark text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-success no-padding b-a b-grey text-master">
                        <div class="bg-white m-t-45 p-t-5 p-l-15 p-b-5 p-r-15">
                    ...
                    <div class="row m-t-10">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-success-light text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-success-lighter text-white">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-warning-darker text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-warning-dark text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-warning no-padding b-a b-grey text-master">
                        <div class="bg-white m-t-45 p-t-5 p-l-15 p-b-5 p-r-15">
                    ...
                    <div class="row m-t-10">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-warning-light text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-warning-lighter text-white">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-danger-darker text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-danger-dark text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-danger no-padding b-a b-grey text-master">
                        <div class="bg-white m-t-45 p-t-5 p-l-15 p-b-5 p-r-15">
                    ...
                    <div class="row m-t-10">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-danger-light text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-danger-lighter text-white">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-info-darker text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-info-dark text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-info no-padding b-a b-grey text-master">
                        <div class="bg-white m-t-45 p-t-5 p-l-15 p-b-5 p-r-15">
                    ...
                    <div class="row m-t-10">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-info-light text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-info-lighter text-white">
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-heading">
                    <div class="panel-title">Menu base color
                    </div>
                  </div>
                  <div class="panel-body">
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-menu-dark text-white">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-menu no-padding b-a b-grey text-master">
                        <div class="bg-white m-t-45 p-t-5 p-l-15 p-b-5 p-r-15">
                    ...
                    <div class="row m-t-10">
                      ...
                      <div class="col-xs-8 col-lg-9 bg-menu-light text-white">
