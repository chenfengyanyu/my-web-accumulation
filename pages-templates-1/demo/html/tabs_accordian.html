      ...
      <div class="page-content-wrapper ">
        ...
        <div class="content ">
            ...
            <div class="container-fluid container-fixed-lg">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href="#" class="active">Tabs &amp; Accordians</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
                <div class="row">
          ...
          <div class="container-fluid container-fixed-lg">
              ...
              <div class="col-md-6">
                ...
                <div class="panel">
                  <ul class="nav nav-tabs nav-tabs-simple" role="tablist" data-init-reponsive-tabs="collapse">
                    <li class="active"><a href="#tab2hellowWorld" data-toggle="tab" role="tab">Hello World</a>
                    </li>
                    <li><a href="#tab2FollowUs" data-toggle="tab" role="tab">Hello Two</a>
                    </li>
                    <li><a href="#tab2Inspire" data-toggle="tab" role="tab">Hello Three</a>
                    </li>
                  </ul>
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab2hellowWorld">
                      <div class="row column-seperation">
                        <div class="col-md-6">
                          <h3>
                                            <span class="semi-bold">Sometimes</span> Small things in life means the most</h3>
                        </div>
                        <div class="col-md-6">
                  ...
                  <div class="col-lg-6">
                    <div class="panel panel-transparent">
                      <ul class="nav nav-tabs nav-tabs-simple nav-tabs-right bg-white" id="tab-4" role="tablist">
                        <li><a href="#tab4hellowWorld" data-toggle="tab" role="tab">One</a>
                        </li>
                        <li><a href="#tab4FollowUs" data-toggle="tab" role="tab">Two</a>
                        </li>
                        <li class="active"><a href="#tab4Inspire" data-toggle="tab" role="tab">Three</a>
                        </li>
                      </ul>
                      <div class="tab-content bg-white">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div class="panel-title">Tabs Styles
                </div>
              </div>
              <div class="panel-body">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="panel panel-transparent">
                      ...
                      <ul class="nav nav-tabs nav-tabs-linetriangle" data-init-reponsive-tabs="dropdownfx">
                        <li class="active">
                          <a data-toggle="tab" href="#home"><span>Hello World</span></a>
                        </li>
                        <li>
                          <a data-toggle="tab" href="#profile"><span>Hello Two</span></a>
                        </li>
                        <li>
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div class="panel-title">Tabs Pane Transitions
                </div>
              </div>
              <div class="panel-body">
                <div class="row">
