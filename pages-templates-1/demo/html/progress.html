      ...
      <div class="page-content-wrapper ">
        ...
        <div class="content ">
            ...
            <div class="container-fluid container-fixed-lg">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href="#" class="active">Progress Bars</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
          ...
          <div class="container-fluid container-fixed-lg">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div class="panel-title">Linear progress
                </div>
              </div>
              <div class="panel-body">
                <div class="row">
          ...
          <div class="container-fluid container-fixed-lg">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div class="panel-title">Linear progress options
                </div>
              </div>
              <div class="panel-body">
                <div class="row">
          ...
          <div class="container-fluid container-fixed-lg">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div class="panel-title">Circular progress
                </div>
              </div>
              <div class="panel-body">
                <div class="row">
          ...
          <div class="container-fluid container-fixed-lg">
            ...
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div class="panel-title">Circular progress options
                </div>
              </div>
              <div class="panel-body">
                <div class="row">
