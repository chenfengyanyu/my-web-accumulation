        ...
        <div class="content ">
          ...
          <div class="container-fluid container-fixed-lg">
            <ul class="breadcrumb">
              ...
              <li><a href="#" class="active">Portlets</a>
              </li>
            </ul>
            <!-- END BREADCRUMB -->
            <!-- START PANEL -->
            <div class="panel panel-transparent">
              <div class="panel-heading ">
                <div class="panel-title">Pages Portlets
                </div>
              </div>
                        ...
                        <div class="panel-heading ">
                          ...
                          <div class="panel-controls">
                            <ul>
                              ...
                              <li><a href="#" class="portlet-maximize" data-toggle="maximize"><i
													class="portlet-icon portlet-icon-maximize"></i></a>
                              </li>
                          ...
                          <div class="panel-heading ">
                            ...
                            <div class="panel-controls">
                              <ul>
                                ...
                                <li><a data-toggle="refresh" class="portlet-refresh" href="#"><i
														class="portlet-icon portlet-icon-refresh"></i></a>
                                </li>
                                <li><a data-toggle="close" class="portlet-close" href="#"><i
														class="portlet-icon portlet-icon-close"></i></a>
                                </li>
                              </ul>
                            </div>
          ...
          <div class="container-fluid container-fixed-lg">
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div class="panel-title">Style Options
                </div>
              </div>
              <div class="panel-body">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="panel panel-transparent">
                      <div class="panel-heading">
                        <div class="panel-title">Portlet Four
                        </div>
                      </div>
                      <div class="panel-body">
                        <h3>
              ...
              <div class="panel-body">
                <div class="col-md-4 no-padding">
                  <div class="p-r-30">
                    ...
                    <br>
                    <p>Pages comes with two types of inderminate progress indicators: linear and circular. These have been created using animated SVGs to support various screen sizes and retina displays. We have integrated them into portlets too.
                    </p>
                    <div class="inline">
                      <p class="small hint-text">
                    ...
                    <div class="panel-body no-padding">
                      <div id="portlet-circular-minimal" class="panel panel-default">
                        ...
                        <div class="panel-body">
                          ...
                          <p>Click on the refresh icon to simulate an AJAX call and to see an animated circular progress indicatorabove the portlet. This is the Pages default progress indicator for portlets. Don't like this style? Simply change the style by setting portlet options.
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div class="container-fluid container-fixed-lg">
            <div class="panel panel-transparent">
              <div class="panel-heading">
                <div class="panel-title">Portlet Progress indicators
                </div>
              </div>
              <div class="panel-body">
                <div class="row">
                  ...
                  <div class="col-md-6 sortable-column">
                    <div class="panel panel-default bg-primary" data-pages="portlet">
                      <div class="panel-heading">
                        ...
                        <div class="panel-controls">
                          <ul>
                            <li><a href="#" class="portlet-collapse text-white" data-toggle="collapse"><i
												class="portlet-icon portlet-icon-collapse"></i></a>
                            </li>
                            <li><a href="#" class="portlet-refresh text-white" data-toggle="refresh"><i
												class="portlet-icon portlet-icon-refresh"></i></a>
                            </li>
                            <li><a href="#" class="portlet-close text-white" data-toggle="close"><i
												class="portlet-icon portlet-icon-close"></i></a>
                            </li>
                          </ul>
                        </div>
