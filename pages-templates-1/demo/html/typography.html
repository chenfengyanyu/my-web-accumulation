...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>Pages - Admin Dashboard UI Kit - Typography</title>
            ...
            <div class="container-fluid container-fixed-lg">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href="#" class="active">Typography</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
          ...
          <div class="container-fluid container-fixed-lg">
            <div class="row">
              <div class="col-sm-3">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-heading">
                    <div class="panel-title">System OS detection
                    </div>
                  </div>
                  <div class="panel-body">
              ...
              <div class="col-sm-3">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-heading">
                    <div class="panel-title">Solution
                    </div>
                  </div>
                  <div class="panel-body">
              ...
              <div class="col-sm-6">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-heading">
                    <div class="panel-title">Recommended Loaded Font
                    </div>
                  </div>
                  <div class="panel-body">
              ...
              <div class="col-sm-4">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-heading m-t-30">
                    <div class="panel-title">Font Guidelines
                    </div>
                  </div>
                  <div class="panel-body">
                  ...
                  <div class="panel-body no-padding">
                    <div class="container-sm-height">
                      <div class="row row-sm-height">
                        <div class="col-sm-9 col-sm-height padding-20 col-top">
          ...
          <div class="container-fluid container-fixed-lg">
            <div class="row">
              <div class="col-lg-5 col-md-3">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-heading">
                    <div class="panel-title">Paint the world
                    </div>
                  </div>
                  <div class="panel-body">
          ...
          <div class="container-fluid container-fixed-lg">
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="panel panel-transparent">
                  <div class="panel-heading">
                    <div class="panel-title">Address Block
                    </div>
                  </div>
                  <div class="panel-body">
