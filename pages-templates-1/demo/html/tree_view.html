...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>Pages - Admin Dashboard UI Kit - Tree View</title>
  ...
  <body class="fixed-header ">
            ...
            <div class="container-fluid container-fixed-lg">
              <div class="inner">
                ...
                <ul class="breadcrumb">
                  ...
                  <li><a href="#" class="active">Tree View</a>
                  </li>
                </ul>
                <!-- END BREADCRUMB -->
                <div class="row">
          ...
          <div class="container-fluid container-fixed-lg">
            <div class="row">
              <div class="col-sm-6">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <div class="panel-title">Drag n Drop
                    </div>
                  </div>
                  <div class="panel-body">
                    <p>You can drag n drop and move sub items to the desired place you want, Please refer the documentation for more details or dynatree documentation
                    </p>
                    <div id="drag-tree">
              ...
              <div class="col-sm-6">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <div class="panel-title">Check Tree
                    </div>
                  </div>
                  <div class="panel-body">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <div class="panel-title">Radio Tree
                    </div>
                  </div>
                  <div class="panel-body">
                    <p>You can make all the items to checkbox or even mix them up with radio controls, Please refer the documentation for more details or dynatree documentation</p>
    ...
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="assets/js/tree_view.js" type="text/javascript"></script>
