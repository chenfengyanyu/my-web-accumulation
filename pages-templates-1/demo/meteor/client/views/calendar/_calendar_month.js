Template.calendarAppMonth.rendered = function (){
        var selectedEvent;
        $('#calendarMonth').pagescalendar({
            ...
            onTimeSlotDblClick: function(timeSlot) {
                ...
                $('#calendarMonth').pagescalendar('addEvent', newEvent);
                setEventDetailsToForm(selectedEvent);
            }
        });
        ...
        $('#eventSave').on('click', function() {
            ...
            $('#calendarMonth').pagescalendar('updateEvent',selectedEvent);

            $('#calendar-event').removeClass('open');
        });

        $('#eventDelete').on('click', function() {
            $('#calendarMonth').pagescalendar('removeEvent', $('#eventIndex').val());
            $('#calendar-event').removeClass('open');
        });
};