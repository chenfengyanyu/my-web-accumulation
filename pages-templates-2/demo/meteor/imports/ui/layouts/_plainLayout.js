...
Template._plainLayout.onRendered(function () {
	var tpl = this;
...
/*
 Template._plainLayout.onCreated(function () {
 var tpl = this;
...
/*
 Template._plainLayout.onDestroyed(function () {
 var tpl = this;
 // de-registration
